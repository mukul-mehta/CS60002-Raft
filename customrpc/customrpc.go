...
import "github.com/rashil2000/CS60002-Raft/customgob"
import "bytes"
import "reflect"
import "sync"
import "log"
...
func (rs *Server) dispatch(req reqMsg) replyMsg {
	...
	if ok {
		...
		log.Fatalf("customrpc.Server.dispatch(): unknown service %v in %v.%v; expecting one of %v\n",
...
func (svc *Service) dispatch(methname string, req reqMsg) replyMsg {
	if method, ok := svc.methods[methname]; ok {
		...
		log.Fatalf("customrpc.Service.dispatch(): unknown method %v in %v; expecting one of %v\n",
